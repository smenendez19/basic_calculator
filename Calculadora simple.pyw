...
def mensajeInfo():
    messagebox.showinfo("Acerca del programa", "Programa realizado por Santiago Menendez siguiendo el tutorial de Pildoras Informaticas , modificado para diferenciar de otros")
